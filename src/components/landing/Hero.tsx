...
const Hero = () => {
  ...
  const toRotate = ["Masa Depan", "Cita-Cita", "Impian"];
  const period = 2000;
  ...
  return (
    <section className="gradient-bg min-h-screen flex items-center justify-center relative z-10 px-6">
      <div className="max-w-6xl mx-auto text-center relative">
        <h1
          className="text-6xl md:text-8xl font-black leading-none text-white mb-8 section-reveal"
        ...
        <p
          className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed mb-12 font-light section-reveal"
        ...
        <div
          className="flex flex-col sm:flex-row gap-6 justify-center items-center section-reveal"
